...
dofile("Core.CommandSage_Trie")
dofile("Core.CommandSage_FuzzyMatch")
dofile("Core.CommandSage_ParameterHelper")
dofile("Core.CommandSage_AdaptiveLearning")
dofile("Core.CommandSage_PersistentTrie")
dofile("Core.CommandSage_Tutorial")
dofile("Core.CommandSage_Performance")
dofile("Core.CommandSage_SecureCallback")
dofile("Core.CommandSage_Fallback")
dofile("Core.CommandSage_CommandOrganizer")
dofile("Core.CommandSage_AutoType")
dofile("Core.CommandSage_HistoryPlayback")
dofile("Core.CommandSage_DeveloperAPI")
dofile("Core.CommandSage_UIAccessibility")
dofile("Core.CommandSage_Analytics")
dofile("Core.CommandSage_MultiModal")
dofile("Core.CommandSage_AROverlays")
dofile("Core.CommandSage_AutoComplete")
dofile("Core.CommandSage_Terminal")
dofile("Core.CommandSage_ShellContext")
dofile("Core.CommandSage_Licensing")
dofile("Core.CommandSage_ConfigGUI")
dofile("Core.CommandSage_KeyBlocker")
