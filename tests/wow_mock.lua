...
CreateFrame = CreateFrame or function(frameType, name, parent, template)
    ...
    function f:EnableMouse(enable) self.mouseEnabled = enable end
    function f:SetMovable(movable) self.movable = movable end
    function f:RegisterForDrag(...) end
    function f:SetBackdrop(backdrop) self.backdrop = backdrop end
    function f:SetBackdropColor(r, g, b, a) self.backdropColor = {r, g, b, a} end
    ...
    function f:SetCursorPosition(pos) self.cursorPosition = pos end
    function f:SetPropagateKeyboardInput(propagate) self.propagateKeyboard = propagate end
...
-- Sound mocks.
PlaySound = PlaySound or function(sound) print("Playing sound:", sound) end
StopSound = StopSound or function(sound) print("Stopping sound:", sound) end
